...
3) If you do not have "node modules" folder install, simply write "npm install" command on the terminal in the project directory to install the necessary dependencies.
